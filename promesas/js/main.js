...
const categorias = prods.filter((prod, index, arr) => {
  ...
  promesa
    .then((response) => {
      response
        ...
        .catch((err) => {
          console.err("Error en formato de la promesa" + err.message);
        }); //catch json
    }) //then response
    .catch((error) => {
      console.error("Error en formato de la promesa" + error.message);
    }); //catch promesa
} // getProductoto
